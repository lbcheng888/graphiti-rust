                ...
                match name {
                    ...
                    "add_memory" => {
                        let req: AddMemoryRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.list_dir" | "serena_list_dir" => {
                        let a: crate::serena_tools::ListDirRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let res = crate::serena_tools::list_dir(a)
                            .await
                    ...
                    "serena.find_file" | "serena_find_file" => {
                        let a: crate::serena_tools::FindFileRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let res = crate::serena_tools::find_file(a)
                            .await
                            .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
                        let response = serde_json::json!({
                            "jsonrpc":"2.0","id":request.get("id"),
                    ...
                    "serena.read_file" | "serena_read_file" => {
                        let a: crate::serena_tools::ReadFileRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let res = crate::serena_tools::read_file(a)
                            .await
                            .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
                        let response = serde_json::json!({
                            "jsonrpc":"2.0","id":request.get("id"),
                    ...
                    "serena.write_file" | "serena_write_file" => {
                        let a: crate::serena_tools::WriteFileRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        crate::serena_tools::write_file(a)
                            .await
                            .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
                        let response = serde_json::json!({
                            "jsonrpc":"2.0","id":request.get("id"),
                    ...
                    "serena.search" | "serena_search" => {
                        let a: crate::serena_tools::SearchRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let res = crate::serena_tools::search(a)
                            .await
                            .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
                        let response = serde_json::json!({
                            "jsonrpc":"2.0","id":request.get("id"),
                    ...
                    "serena.replace_lines" | "serena_replace_lines" => {
                        let a: crate::serena_tools::ReplaceLinesRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        crate::serena_tools::replace_lines(a)
                            .await
                            .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
                        let response = serde_json::json!({
                            "jsonrpc":"2.0","id":request.get("id"),
                    ...
                    "serena.delete_lines" | "serena_delete_lines" => {
                        let a: crate::serena_tools::DeleteLinesRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        crate::serena_tools::delete_lines(a)
                            .await
                            .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
                        let response = serde_json::json!({
                            "jsonrpc":"2.0","id":request.get("id"),
                    ...
                    "serena.insert_at_line" | "serena_insert_at_line" => {
                        let a: crate::serena_tools::InsertAtLineRequest =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        crate::serena_tools::insert_at_line(a)
                            .await
                            .map_err(|_| StatusCode::INTERNAL_SERVER_ERROR)?;
                        let response = serde_json::json!({
                            "jsonrpc":"2.0","id":request.get("id"),
                    ...
                    "serena.get_current_config" | "serena_get_current_config" => {
                        ...
                        let a: A =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let v = crate::handlers::serena::get_current_config(
                            crate::handlers::serena::GetConfigArgs { project: a.project },
                        )
                        .await?;
                    ...
                    "serena.symbols_overview" | "serena_symbols_overview" => {
                        let a: crate::handlers::serena::SymbolsOverviewArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.find_symbol" | "serena_find_symbol" => {
                        let a: crate::handlers::serena::FindSymbolArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.find_referencing_symbols" | "serena_find_referencing_symbols" => {
                        let a: crate::handlers::serena::FindRefsArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.replace_symbol_body" | "serena_replace_symbol_body" => {
                        let a: crate::handlers::serena::ReplaceSymbolBodyArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.ra.document_symbols" | "serena_ra_document_symbols" => {
                        let a: crate::handlers::serena::RaDocumentSymbolsArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.ra.workspace_symbol" | "serena_ra_workspace_symbol" => {
                        let a: crate::handlers::serena::RaWorkspaceSymbolArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.ra.references" | "serena_ra_references" => {
                        let a: crate::handlers::serena::RaReferencesArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.ra.definition" | "serena_ra_definition" => {
                        let a: crate::handlers::serena::RaDefinitionArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena.ra.status" | "serena_ra_status" => {
                        let a: crate::handlers::serena::RaRootArgs = serde_json::from_value(args)
                            .unwrap_or(crate::handlers::serena::RaRootArgs {
                                root: String::new(),
                            });
                    ...
                    "serena.ra.restart" | "serena_ra_restart" => {
                        let a: crate::handlers::serena::RaRootArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    | "serena_kg_ra_document_symbols_to_entities" => {
                        let a: crate::handlers::serena::RaDocSymbolsToEntitiesArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg =
                            crate::handlers::serena::ra_document_symbols_to_entities(&state, a)
                                .await?;
                    ...
                    "serena_kg.ra_file_symbols_connect" | "serena_kg_ra_file_symbols_connect" => {
                        let a: crate::handlers::serena::RaFileSymbolsConnectArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg =
                            crate::handlers::serena::ra_file_symbols_connect(&state, a).await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                        Ok(Json(response))
                    }
                    "serena_kg.ra_workspace_file_symbols_connect"
                    | "serena_kg_ra_workspace_file_symbols_connect" => {
                        let a: crate::handlers::serena::RaWorkspaceFileSymbolsConnectArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg =
                            crate::handlers::serena::ra_workspace_file_symbols_connect(&state, a)
                                .await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                        Ok(Json(response))
                    }
                    "serena_kg.ra_import_and_connect_file"
                    | "serena_kg_ra_import_and_connect_file" => {
                        let a: crate::handlers::serena::RaImportAndConnectFileArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg =
                            crate::handlers::serena::ra_import_and_connect_file(&state, a).await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                        Ok(Json(response))
                    }
                    "serena_kg.ra_build_symbols_and_connect_workspace"
                    | "serena_kg_ra_build_symbols_and_connect_workspace" => {
                        let a: crate::handlers::serena::RaBuildSymbolsAndConnectWorkspaceArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg = crate::handlers::serena::ra_build_symbols_and_connect_workspace(
                            &state, a,
                        )
                        .await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                    ...
                    "serena_kg.replace_lines_and_record" | "serena_kg_replace_lines_and_record" => {
                        let a: crate::handlers::serena::ReplaceLinesAndRecordArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena_kg.recent_edges" | "serena_kg_recent_edges" => {
                        let a: crate::handlers::serena::RecentEdgesArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena_kg.prune_edges" | "serena_kg_prune_edges" => {
                        let a: crate::handlers::serena::PruneEdgesArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    "serena_kg.onboarding_done" | "serena_kg_onboarding_done" => {
                        let a: crate::handlers::serena::OnboardingDoneArgs =
                            serde_json::from_value(args).unwrap_or(
                                crate::handlers::serena::OnboardingDoneArgs { project: None },
                            );
                    ...
                    "serena_kg.ra_build_workspace" | "serena_kg_ra_build_workspace" => {
                        let a: crate::handlers::serena::RaBuildWorkspaceArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                    ...
                    | "serena_kg_ra_build_references_workspace" => {
                        let a: crate::handlers::serena::RaBuildReferencesWorkspaceArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg = crate::handlers::serena::ra_build_references_workspace(&state, a)
                            .await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                        Ok(Json(response))
                    }
                    "serena_kg.ra_references_to_edges" | "serena_kg_ra_references_to_edges" => {
                        let a: crate::handlers::serena::RaReferencesToEdgesArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg =
                            crate::handlers::serena::ra_references_to_edges(&state, a).await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                        Ok(Json(response))
                    }
                    "serena_kg.ra_symbol_definition_edge"
                    | "serena_kg_ra_symbol_definition_edge" => {
                        let a: crate::handlers::serena::RaSymbolDefinitionEdgeArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg =
                            crate::handlers::serena::ra_symbol_definition_edge(&state, a).await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                        Ok(Json(response))
                    }
                    "serena_kg.ra_build_references_for_file"
                    | "serena_kg_ra_build_references_for_file" => {
                        let a: crate::handlers::serena::RaBuildReferencesForFileArgs =
                            serde_json::from_value(args).map_err(|_| StatusCode::BAD_REQUEST)?;
                        let msg = crate::handlers::serena::ra_build_references_for_file(&state, a)
                            .await?;
                        let response = serde_json::json!({"jsonrpc":"2.0","id":request.get("id"),"result":{"content":[{"type":"text","text": msg}]}});
                        Ok(Json(response))
                    }
